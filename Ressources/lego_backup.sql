...
--
-- Hôte : mysql
-- Généré le : ven. 14 mars 2025 à 09:33
...
CREATE TABLE `lego` (
  ...
  `pieces` int NOT NULL,
  `image_box` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `lego` (`id`, `name`, `description`, `price`, `pieces`, `image_box`, `image_main`, `collection_id`) VALUES
